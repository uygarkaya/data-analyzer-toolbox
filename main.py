...
from core.callbacks.train_model import TrainModelCallbacks
...
class DatasetAnalyzerApplication:
    def __init__(self):
        ...
        self.train_model_callbacks = TrainModelCallbacks(self.dashboard)
...
def main():
    ...
    app.train_model_callbacks.register_callbacks()
